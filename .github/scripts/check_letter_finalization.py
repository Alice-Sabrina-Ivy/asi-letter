...
def write_outputs(path: Optional[str], should_run: bool, index_height: str, proof_height: str) -> None:
    if not path:
        return
...
def evaluate(
    ...
    if ots_height and index_height == ots_height:
        ...
        return False, index_height, ots_height
    ...
    return True, index_height, ots_height
...
def main() -> int:
    ...
    should_run, index_height, proof_height = evaluate(
        args.event_name,
        args.repository,
        branch,
        force=args.force == "true",
    )
    write_outputs(args.github_output, should_run, index_height, proof_height)
