...
| `render_index_html.py` | Renders `docs/letter.md` into HTML and injects it into `docs/index.html`. | Requires the Python `markdown` package; fails if render markers are missing. | Produces static HTML so the site renders without JavaScript. |
